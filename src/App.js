      ...
      <footer>
        <div className="footer-container ">
          ...
          <div className="connect-withme">
            <a href="https://twitter.com/mant3sh" target="_blank">
              <img src={twit} alt="" />
            </a>
            <a href="https://github.com/mant3sh" target="_blank">
              <img className="gitimg" src={gitimage} alt="" />
            </a>
          </div>
          <p>
            <strong>Disclaimer:</strong> This page is only for fun
          </p>

          <div className="connect-withme">
            <a href="https://status.chucknorris.io/">Status</a>
